...
- Version-1 bounded Henka network packet codec and localhost ENet transport with explicit little-endian headers, three logical channels, reliable ordered delivery, a 64 KiB packet ceiling, 32 KiB snapshot fragments, authoritative Terrain deltas/snapshots, and a renderer-free client session adapter; reconnect, late-join orchestration, and multiplayer soak validation remain unfinished
