...
- Bounded Windows Terrain streaming foundation with a renderer-free worker, coalesced region requests, fixed request/completion queues, observer records, cancellation, candidate validation, main-thread region swaps, deterministic clean-region eviction, optional unload hysteresis, and stream diagnostics; physics/render radius automation remains unfinished
