...
- Sandbox workspace panels with stacked side docks, header drag, cross-zone redocking, native detached-window state, safer tool-window renderer context recovery, dock splitter, and reset-layout recovery controls
