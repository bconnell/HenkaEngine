...
- Dedicated-server edit handling lazily materializes requested persisted regions within the configured residency bound before authority validation, avoiding a world-sized preload; eviction policy and asynchronous physics/render regeneration remain unfinished
