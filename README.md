...
- Rendered presentation includes bounded RG camera- and object-motion history reprojection with an 8-sample subpixel jitter sequence, current-depth plus 3x3 depth-neighborhood rejection, reactive handling for transparency/transmission/emissive pixels, neighborhood history clamping, and bounded reconstruction sharpening, plus normal-aware depth-neighborhood ambient occlusion; horizon-search GTAO and production TAA visual validation across camera cuts, resize, disocclusion, and moving-object cases remain unfinished
