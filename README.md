...
- In-window editor UI with mixed-case built-in text, restrained graphite/slate surfaces, lower-contrast one-pixel framing, quieter structured rows, clear selected-state accents, and release-confirm control activation
