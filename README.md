...
- Renderer-independent Terrain collision patch extraction copies a physics-resident chunk into a bounded 65 x 65 signed-millimeter height patch with revision and generation identity; a bounded transactional Terrain physics patch owner retains replacements and answers deterministic height/normal queries, and the rigid-body API now owns copied static heightfield colliders with sphere/box contacts and bounded raycasts; automatic regeneration scheduling and runtime collision stress validation remain unfinished
