...
- Renderer-independent Terrain chunk mesh generation now converts a render-resident chunk into caller-owned LOD 0-3 vertices and indices with finite height-derived normals, world UVs, material weights, and source revision/generation identity; graphical mesh upload, GPU residency, seam stitching, and visual validation remain unfinished
