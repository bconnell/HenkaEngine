...
- Rendered presentation includes bounded RG camera- and object-motion history reprojection with an 8-sample subpixel jitter sequence, current-depth plus 3x3 depth-neighborhood rejection, and 3x3 neighborhood history clamping, plus depth-neighborhood ambient occlusion; normal-aware GTAO and production TAA with sharpening, reactive masks, and a complete disocclusion contract remain unfinished
