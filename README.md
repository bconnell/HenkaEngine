...
- Transactional recovery for incompatible saved live workspace panel/topology state; current safe defaults replace the bad live layout and are rewritten on clean shutdown without discarding valid saved custom layouts or named slots
