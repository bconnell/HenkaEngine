...
- Visible KTX2 texture residency requests now carry deterministic projected-radius, distance-fallback, and semantic-slot priorities; the bounded queue coalesces strongest mip demand and services higher-priority references first, while active-frame pins keep referenced manager-owned textures out of trim. Background I/O and automatic eviction policy remain unfinished
