...
- The optional terrain visual evidence capture uses one deterministic reference camera across Solid, Material Preview, and Rendered without changing scene materials or scene lights; it is application-only evidence for the rolling/valley/cliff/four-layer fixture, while human visual approval remains unfinished
