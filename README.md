...
- The optional terrain visual evidence capture uses deterministic wide and four-region-corner cameras across Solid, Material Preview, and Rendered without changing scene materials or scene lights; capture mode refreshes the four bounded fixture regions from their seeded samples so persisted editor edits cannot change the comparison. The capture helper can target either the development or packaged executable and runs bounded Scene View guards that reject missing, dimension-mismatched, flat evidence and require a measurable Rendered-versus-Material Preview difference for both views; it remains application-only evidence, while human visual approval and complete topology QA remain unfinished
