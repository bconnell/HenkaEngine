...
- Rendered presentation includes bounded RG camera- and object-motion history reprojection with an 8-sample subpixel jitter sequence, a current-depth consistency rejection, and depth-neighborhood ambient occlusion; normal-aware GTAO and production TAA with neighborhood clamping, sharpening, and complete disocclusion handling remain unfinished
