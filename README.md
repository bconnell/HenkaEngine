...
- Sandbox smoke additionally sends one shared integer raise command through the Terrain world, automatically refreshes the stale render mesh revision, and replaces the bounded collision patch transactionally; viewport editor interaction, persistence controls, and networked edit authority remain separate unfinished integrations
