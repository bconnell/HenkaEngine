...
static const henka_script_api_function g_schema[] =
{
    ...
    },
    {
        ...
        HENKA_SCRIPT_API_VALUE_RESULT,
        2U,
        {HENKA_SCRIPT_API_VALUE_ENTITY, HENKA_SCRIPT_API_VALUE_FLOAT32,
         HENKA_SCRIPT_API_VALUE_VOID, HENKA_SCRIPT_API_VALUE_VOID}
    },
    {
    ...
    },
    {
        ...
        HENKA_SCRIPT_API_VALUE_RESULT,
        2U,
        {HENKA_SCRIPT_API_VALUE_ENTITY, HENKA_SCRIPT_API_VALUE_BOOL,
         HENKA_SCRIPT_API_VALUE_VOID, HENKA_SCRIPT_API_VALUE_VOID}
    },
    {
    ...
    },
    {
        ...
        HENKA_SCRIPT_API_VALUE_RESULT,
        2U,
        {HENKA_SCRIPT_API_VALUE_ENTITY, HENKA_SCRIPT_API_VALUE_I32,
         HENKA_SCRIPT_API_VALUE_VOID, HENKA_SCRIPT_API_VALUE_VOID}
    },
    {
