...
#define HENKA_SCENE_DOCUMENT_FORMAT_VERSION UINT32_C(17)
#define HENKA_SCENE_DOCUMENT_LEGACY_FORMAT_VERSION_V16 UINT32_C(16)
...
#define HENKA_SCENE_DOCUMENT_MAX_TAG_BYTES 128U
...
typedef struct henka_scene_document_object
{
    ...
    char tag[HENKA_SCENE_DOCUMENT_MAX_TAG_BYTES];
    bool visible;
