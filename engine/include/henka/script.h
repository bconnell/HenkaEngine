...
typedef enum henka_script_api_id
{
    ...
    HENKA_SCRIPT_API_AUDIO_STOP = UINT32_C(0x0801),
    HENKA_SCRIPT_API_AUDIO_RESTART = UINT32_C(0x0802),
    HENKA_SCRIPT_API_AUDIO_IS_PLAYING = UINT32_C(0x0803),
    HENKA_SCRIPT_API_AUDIO_PLAY = UINT32_C(0x0804),
    HENKA_SCRIPT_API_AUDIO_PAUSE = UINT32_C(0x0805),
    HENKA_SCRIPT_API_AUDIO_RESUME = UINT32_C(0x0806),
    HENKA_SCRIPT_API_AUDIO_SET_GAIN = UINT32_C(0x0807),
    HENKA_SCRIPT_API_AUDIO_SET_PITCH = UINT32_C(0x0808),
    HENKA_SCRIPT_API_AUDIO_SET_LOOPING = UINT32_C(0x0809),
    HENKA_SCRIPT_API_AUDIO_SET_SPATIAL = UINT32_C(0x080A),
    HENKA_SCRIPT_API_AUDIO_SET_BUS = UINT32_C(0x080B),
    HENKA_SCRIPT_API_AUDIO_SEEK = UINT32_C(0x080C)
} henka_script_api_id;
