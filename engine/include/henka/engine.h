...
typedef struct henka_engine_diagnostics
{
    ...
    uint32_t rendered_temporal_history_allocation_failure_count;
    bool rendered_temporal_previous_history_retained;
...
henka_result henka_engine_get_window_position(const henka_engine* engine, int* out_x, int* out_y);
