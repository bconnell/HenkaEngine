...
typedef enum henka_hks_token_kind
{
    ...
    HENKA_HKS_TOKEN_KW_AUDIO_STOP,
    HENKA_HKS_TOKEN_KW_AUDIO_RESTART,
    HENKA_HKS_TOKEN_KW_AUDIO_IS_PLAYING,
    HENKA_HKS_TOKEN_KW_AUDIO_PLAY,
    HENKA_HKS_TOKEN_KW_AUDIO_PAUSE,
    HENKA_HKS_TOKEN_KW_AUDIO_RESUME,
    HENKA_HKS_TOKEN_KW_AUDIO_SET_GAIN,
    HENKA_HKS_TOKEN_KW_AUDIO_SET_PITCH,
    HENKA_HKS_TOKEN_KW_AUDIO_SET_LOOPING,
    HENKA_HKS_TOKEN_KW_AUDIO_SET_SPATIAL,
    HENKA_HKS_TOKEN_KW_AUDIO_SET_BUS,
    HENKA_HKS_TOKEN_KW_AUDIO_SEEK,
