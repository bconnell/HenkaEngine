...
Write-Host "Open Physics QA from Tools for body-type notes and quick drop tests."
Write-Host "Press F5 to switch Standard and Focus Viewport."
...
Write-Host "Use Open Native Panel Test in Tools to exercise the separate-window foundation."
