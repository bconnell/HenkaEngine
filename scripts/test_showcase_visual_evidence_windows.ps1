...
try {
    ...
    $metadata = @(
        "solid metadata: CAPTURE_READY mode=solid viewport=0,0,640,360 aspect=1.777778 camera_position=0.0000,0.0000,5.0000 yaw=-1.570796 pitch=0.000000 roll=0.000000 fov=1.047198 giraffe_bounds=-2.0,2.0,0.0,1.0,2.0,1.0 rocket_bounds=2.0,2.0,0.0,1.0,2.0,1.0 combined_bounds=0.0,2.0,0.0,3.0,2.0,1.0 giraffe_screen=50.00,30.00,250.00,330.00 rocket_screen=390.00,30.00,590.00,330.00 combined_midpoint=320.00,180.00 giraffe_parts=8 rocket_parts=5 giraffe_sss_regions=5 giraffe_normal_texture_regions=5 giraffe_normal_texture_loaded=5 giraffe_normal_texture_fallbacks=0 settled_frames=3 draw_expected=1",
