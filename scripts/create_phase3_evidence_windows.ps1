...
Write-Report -RelativePath "Handoff\remaining-campaign-tracks.txt" -Text "Not silently claimed complete: dedicated local probe capture cubemaps and editor visualization, production LOD/instancing/texture residency streaming, AO/SSR beyond the documented IBL fallback, soak/fault coverage, CI verification, and same-camera app-only Solid/Material Preview/Rendered visual evidence.`r`n"
