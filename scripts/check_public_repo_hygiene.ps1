...
$ruleSpecs = @(
    ...
    @{ Name = "private execution-agent framing 3"; Token = Convert-CodePoints @(97, 103, 101, 110, 116, 45, 114, 111, 108, 101, 32, 108, 97, 110, 103, 117, 97, 103, 101); CaseSensitive = $false },
    @{ Name = "private prompt reference"; Token = Convert-CodePoints @(112, 114, 105, 118, 97, 116, 101, 32, 112, 114, 111, 109, 112, 116, 115); CaseSensitive = $false },
    @{ Name = "internal generation reference 1"; Token = Convert-CodePoints @(76, 76, 77); CaseSensitive = $false },
    @{ Name = "internal generation reference 2"; Token = Convert-CodePoints @(67, 104, 97, 116, 71, 80, 84); CaseSensitive = $false },
    @{ Name = "internal generation reference 3"; Token = Convert-CodePoints @(67, 111, 100, 101, 120); CaseSensitive = $false },
    @{ Name = "internal generation reference 4"; Token = Convert-CodePoints @(79, 112, 101, 110, 65, 73); CaseSensitive = $false },
    @{ Name = "internal generation reference 5"; Token = Convert-CodePoints @(97, 114, 116, 105, 102, 105, 99, 105, 97, 108, 32, 105, 110, 116, 101, 108, 108, 105, 103, 101, 110, 99, 101); CaseSensitive = $false },
    @{ Name = "internal generation reference 6"; Token = Convert-CodePoints @(108, 97, 110, 103, 117, 97, 103, 101, 32, 109, 111, 100, 101, 108); CaseSensitive = $false },
    @{ Name = "internal generation reference 7"; Token = Convert-CodePoints @(99, 111, 100, 105, 110, 103, 32, 97, 103, 101, 110, 116); CaseSensitive = $false },
    @{ Name = "internal generation reference 8"; Token = Convert-CodePoints @(103, 101, 110, 101, 114, 97, 116, 101, 100, 32, 98, 121); CaseSensitive = $false },
