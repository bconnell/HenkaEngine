...
- a bounded three-lobe direct-light diffusion-profile approximation for subsurface-tinted materials, with authored thickness widening the profile and a bounded back-facing environment contribution; diffuse energy is reserved so the response is not simply added on top of full diffuse. This is still not true multi-scatter diffusion, a skin/wax profile, thickness-texture SSS, or screen-space/ray-traced SSS;
