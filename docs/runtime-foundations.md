...
The renderer diagnostics also report the last scene draw-call count, visible-entity count, and conservative frustum-cull count. These are bounded per-frame counters, not a claim of GPU timing or complete draw-cost attribution.
