...
V1 uses axis-aligned boxes. Rotated-box collision, mesh colliders, constraints, continuous collision detection, Character Controller integration, and advanced simulation remain future work.
