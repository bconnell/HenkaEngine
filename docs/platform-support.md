...
The C source is organized for broader portability, and SDL provides cross-platform foundations, but other operating systems are not currently claimed as validated targets. Non-Windows CMake configuration reports that status. It does not present an unverified support claim.
