...
- Scene-owned render settings, environment, value-owned local lights, and reflection probes persist through the supported Scene Document v16 path and are consumed by Play and packaged Rendered startup within the bounded renderer scope. Point-light direction and cone fields are canonicalized because they have no point-light rendering meaning; spotlights retain validated normalized direction and bounded cones.
