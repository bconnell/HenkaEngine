...
5. Published Vertex operations include Merge Center, Merge Active, Merge by
   ...
   including the one-face corner case, homogeneous closed interior vertex-fan
   ...
   incompatible-normal fan cases fail closed; generalized interior
...
1. Generalized Vertex Extrude beyond connected open boundary fans and the
   bounded homogeneous closed-fan cap replacement, broader non-manifold or
