...
- [ ] **Step 1: Write the failing fixed-capacity and round-trip tests**
...
- [ ] **Step 3: Implement the fixed store and validation helpers**
...
- [ ] **Step 4: Implement candidate-based binary load and atomic save**
...
- [ ] **Step 6: Commit the state-store slice**
...
- [ ] **Step 1: Add host contract tests**
...
- [ ] **Step 2: Add schema IDs and typed value forms**
...
- [ ] **Step 3: Implement context-aware state dispatch**
...
- [ ] **Step 4: Propagate behavior identity around callbacks**
...
- [ ] **Step 2: Add HenkaScript state syntax tests**
...
- [ ] **Step 3: Implement adapters with bounded stack/register behavior**
...
- [ ] **Step 4: Run both backend tests and Lua-disabled compilation**
...
- [ ] **Step 1: Add isolation tests first**
...
- [ ] **Step 2: Make Play own and bind the state store**
...
- [ ] **Step 3: Add coordinator save/load seams**
...
- [ ] **Step 4: Run Play/authoring integration tests**
...
- [ ] **Step 1: Document explicit state persistence and isolation**
