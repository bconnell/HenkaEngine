...
Retained screenshots can support a later worktree only when the capture index binds the current executable/source commit, source hashes, and capture metadata.
