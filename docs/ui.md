...
- Tab/Shift+Tab cycles focus across visible workspace panels with wraparound; the focused panel header receives a visible accent and focus does not enter hidden or detached-stale panels
